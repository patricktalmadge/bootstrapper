...
class Form extends Facade
{
     ...
     * @return string
     */
    public static function vertical_open_for_files(
        $action = null,
        $method = 'POST',
        $attributes = array(),
        $https = null
    ...
    public static function labelled_checkbox($name, $label, $value = 1, $checked = false, $attributes = array())
    {
        ...
        return '<label class="checkbox">' . static::checkbox(
            $name,
            $value,
            $checked,
            $attributes
    ...
    public static function inline_labelled_checkbox($name, $label, $value = 1, $checked = false, $attributes = array())
    {
        ...
        return '<label class="checkbox-inline">' . static::checkbox(
            $name,
            $value,
            $checked,
            $attributes
    ...
    {
        return '<label class="radio">' . static::radio(
            $name,
            $value,
            $checked,
            $attributes
    ...
    {
        return '<label class="radio-inline">' . static::radio(
            $name,
            $value,
            $checked,
            $attributes
