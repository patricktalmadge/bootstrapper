...
class MediaObject
{
    ...
    {
        return "<{$tag} class='media'><a href='{$contents['link']}' class='pull-left'><img class='media-object' src='{$contents['image']}' alt='{$contents['heading']}'></a><div class='media-body'><h4 class='media-heading'>{$contents['heading']}</h4>{$contents['body']}</div></{$tag}>";
    }
}
