...
class ProgressBarSpec extends ObjectBehavior
{
    ...
    function it_can_be_rendered()
    {
        $this->render()->shouldBe(
            "<div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='0' aria-valuemin='0' aria-valuemax='100'><span class='sr-only'>0% complete</span></div></div>"
        );
    }

    function it_can_be_given_a_value()
    {
        $this->value(20)->render()->shouldBe(
    ...
    function it_can_be_given_a_type()
    {
        ...
        foreach ($types as $type) {
            ...
            $this->$type()->render()->shouldBe(
                "<div class='progress'><div class='progress-bar progress-bar-{$class}' role='progressbar' aria-valuenow='0' aria-valuemin='0' aria-valuemax='100'><span class='sr-only'>0% complete</span></div></div>"
            );
        }
    }
    ...
    {
        $this->striped()->render()->shouldBe(
            "<div class='progress'><div class='progress-bar progress-bar-striped' role='progressbar' aria-valuenow='0' aria-valuemin='0' aria-valuemax='100'><span class='sr-only'>0% complete</span></div></div>"
        );
    }

    function it_can_be_animated()
    {
        $this->striped()->animated()->render()->shouldBe(
            "<div class='progress'><div class='progress-bar progress-bar-striped active' role='progressbar' aria-valuenow='0' aria-valuemin='0' aria-valuemax='100'><span class='sr-only'>0% complete</span></div></div>"
        );
    }

    function it_is_smart_enough_to_stripe_when_animated()
    {
        $this->animated()->render()->shouldBe(
            "<div class='progress'><div class='progress-bar progress-bar-striped active' role='progressbar' aria-valuenow='0' aria-valuemin='0' aria-valuemax='100'><span class='sr-only'>0% complete</span></div></div>"
        );
    }
    ...
    function it_allows_you_to_use_shortcuts()
    {
        ...
        foreach ($types as $type) {
            $class = $type == 'normal' ? 'default' : $type;
            $this->$type(40)->render()->shouldBe(
                "<div class='progress'><div class='progress-bar progress-bar-{$class}' role='progressbar' aria-valuenow='40' aria-valuemin='0' aria-valuemax='100' style='width: 40%'><span class='sr-only'>40% complete</span></div></div>"
            );
        }
    }
    ...
    {
        $this->visible('Here is a value! %s%%')->render()->shouldBe(
            "<div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='0' aria-valuemin='0' aria-valuemax='100'>Here is a value! 0%</div></div>"
        );
    }
}
